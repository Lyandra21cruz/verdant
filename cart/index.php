...
<div class="container">
    <div class="linha-produtos">
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos7.jpg" alt="Bolsa Ecológica" class="produtominiatura">
            </div>
            <div class="titulo">
                <p>Bolsa Ecológica</p>
                <h2>R$32,45</h2>
    ...
    <a href="?adicionar=true&produto_id=1&nome=Bolsa+Sustent%C3%A1vel&preco=42.45" class="btn-carrinho">
        ...
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos8.jpg" alt="Bolsa Térmica" class="produtominiatura">
            </div>
            <div class="titulo">
                <p>Bolsa Térmica</p>
                <h2>R$32,45</h2>
    ...
    <a href="?adicionar=true&produto_id=1&nome=Bolsa+Sustent%C3%A1vel&preco=42.45" class="btn-carrinho">
        ...
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos9.jpg" alt="Bolsa de Juta" class="produtominiatura">
            </div>
            <div class="titulo">
                <p>Bolsa de Juta</p>
                <h2>R$32,45</h2>
...
<div class="container">
    <div class="linha-produtos">
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos10.jpg" alt="Bolsa de Algodão Cru" class="produtominiatura">
            </div>
            <div class="titulo">
    ...
    <a href="?adicionar=true&produto_id=1&nome=Bolsa+Sustent%C3%A1vel&preco=42.45" class="btn-carrinho">
        ...
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos11.jpg" alt="Bolsa de Papel Kraft" class="produtominiatura">
            </div>
            <div class="titulo">
    ...
    <a href="?adicionar=true&produto_id=1&nome=Bolsa+Sustent%C3%A1vel&preco=42.45" class="btn-carrinho">
        ...
        <div class="corpoproduto">
            <div class="imgproduto">
                <img src="assets/img/produtos12.jpg" alt="Bolsa Compacta Reutilizável" class="produtominiatura">
            </div>
            <div class="titulo">
